<template lang="html">
  ...
  <svg v-if="arrow || icon == 'arrow'" class="arrow" :class="{'rainbow-hover':rainbowHover,'is-rainbow':rainbow}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 371.45 371.43">
  ...
  <svg v-else-if="wayfinder || icon == 'wayfinder'" class="wayfinder" :class="{'rainbow-hover':rainbowHover,'is-rainbow':rainbow}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900.08 1199.9">
  ...
  <svg v-else-if="instagram || icon == 'instagram'" class="instagram" :class="{'rainbow-hover':rainbowHover,'is-rainbow':rainbow}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 301.29 301.31">
  ...
  <svg v-else-if="facebook || icon == 'facebook'" class="facebook" :class="{'rainbow-hover':rainbowHover,'is-rainbow':rainbow}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 359.57 357.36">
  ...
  <svg v-else-if="calendar || icon == 'calendar'" class="calendar" :class="{'rainbow-hover':rainbowHover,'is-rainbow':rainbow}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 442.6 470.26">
