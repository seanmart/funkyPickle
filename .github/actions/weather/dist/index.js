...
const command_1 = __nccwpck_require__(345);
const file_command_1 = __nccwpck_require__(72);
const utils_1 = __nccwpck_require__(659);
const os = __importStar(__nccwpck_require__(37));
...
const auth_1 = __nccwpck_require__(291);
...
const pm = __nccwpck_require__(969);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(601);
            }
            const agentOptions = {
...
if (!globalThis.ReadableStream) {
  ...
  try {
    ...
    Object.assign(globalThis, __nccwpck_require__(337))
  }
}
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(400);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(230);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(400);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(654);
...
var core = __nccwpck_require__(807);
...
var escape_html = __nccwpck_require__(778);
...
var fetch_blob = __nccwpck_require__(400);
// EXTERNAL MODULE: ./node_modules/formdata-polyfill/esm.min.js
var esm_min = __nccwpck_require__(838);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require__.e(/* import() */ 529).then(__nccwpck_require__.bind(__nccwpck_require__, 529));
...
async function getWeather(){
  ...
  const PRISMIC_END_POINT = (0,core.getInput)('PRISMIC_END_POINT')
  const WEATHER_ACCESS_TOKEN = (0,core.getInput)('WEATHER_ACCESS_TOKEN')
  ...
  if (events){
    ...
    await fs.writeFile('eventsWeatherData/index.js',fileJSON,(err)=>{
      if (err) throw err;
